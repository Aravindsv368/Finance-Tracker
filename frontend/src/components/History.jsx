...
const History = () => {
  ...
  useEffect(() => {
    ...
    setMaxExpense(expensePrices.length ? Math.min(...expensePrices) : 0); //*******
  });
  ...
  return (
    <div className="w-full hidden lg:block mx-auto p-4">
      ...
      <div className="space-y-4 h-18 overflow-y-scroll">
      ...
      <div className="mt-1 rounded-lg p-6">
        ...
        <div className="w-full md:w-[400px] h-[400px] mx-auto">
